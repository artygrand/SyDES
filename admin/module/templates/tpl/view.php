...
<?php }?>
				<tr>
					<td> </td>
					<td><a class="btn btn-default pull-right ajaxmodal" data-url="?mod=templates&act=modal_layout_new"><?php echo lang('add');?></a></td>
				</tr>
			</tbody>
		</table>
	</div>
...
<?php }?>
				<tr>
					<td> </td>
					<td><a class="btn btn-default pull-right ajaxmodal" data-url="?mod=templates&act=modal_saveas&file=new.html"><?php echo lang('add');?></a></td>
				</tr>
			</tbody>
		</table>
	</div>
